    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="mx-auto max-w-7xl px-5 py-8 sm:px-8 lg:px-10">
          ...
          <div className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-sm">
            ...
            {activeAlerts.length === 0 ? (
              <div className="mt-6 rounded-3xl border border-dashed border-emerald-300 bg-emerald-50 p-8 text-center">
                ...
                <p className="mt-4 font-semibold text-emerald-950">Nenhum alerta ativo</p>
                    ...
                    >
                      <div className="flex flex-col gap-4 sm:flex-row sm:items-start">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="mt-4 leading-7 text-slate-700">{alert.message}</p>
                          ...
                          <div className="mt-5 flex flex-col gap-3 sm:flex-row">
                            {alert.status === "OPEN" && (
                              <button
                                type="button"
                                onClick={() => updateAlert(alert.publicId, "acknowledge")}
        ...
        <section className="mt-6 grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
          <div className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-sm">
            <h2 className="text-xl font-semibold text-slate-950">Histórico de eventos</h2>
