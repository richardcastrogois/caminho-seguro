...
export function PublicHelpForm({ token }: PublicHelpFormProps) {
  ...
  if (successReference) {
    return (
      <div className="rounded-[32px] border border-emerald-200 bg-white p-7 text-center shadow-xl shadow-emerald-950/5 sm:p-10">
        ...
        <p className="mt-6 text-sm leading-6 text-slate-500">
          Em situação de emergência imediata, acione os serviços públicos de emergência
  ...
  return (
    <div className="rounded-[32px] border border-slate-200 bg-white p-5 shadow-xl shadow-slate-950/5 sm:p-8">
      <div>
